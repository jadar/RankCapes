...
public class GuiCapeSelect extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        GuiButton buttonSet = new GuiButton(0, this.guiLeft + 31, this.guiTop + 138, 30, 20, LanguageRegistry.instance().getStringLocalization("rankcapes.button.set"));
        ...
        List<String> availableCapes = CapeHandler.INSTANCE.availableCapes;
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.enabled)
        {
            ...
            else if (button instanceof GuiCapeButton)
            {
                ...
                if (button.id != 3)
                {
                    AbstractCape cape = CapeHandler.INSTANCE.getCape(capeName);
     ...
     *
     * @param pageNumber the number of the page to go to
     */
